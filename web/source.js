...
const HANDLING_FIELDS = {
  engine: [
    ...
    { key: 'fInitialDriveForce',label: 'Acceleration / Engine Power',     min: 0.01, max: 2.0,    step: 0.01, default: 0.3,   tags: ['acceleration','power','fast','speed','torque','beschleunigung','schnell','kraft','motor'],
      desc: 'Engine torque multiplier. Higher = faster acceleration AND higher achievable top speed. Must be increased together with Top Speed to have effect.' },
...
const VALUE_LEVELS = {
  ...
  fInitialDriveForce: [
    ...
    { max: 0.30, label: { de: 'Mäßig (Serienfahrzeug)', en: 'Moderate (Stock)'  }, color: '#f97316' },
    { max: 0.50, label: { de: 'Normal',               en: 'Normal'            }, color: '#555'    },
    { max: 0.70, label: { de: 'Stark (Sportfahrzeug)', en: 'Strong (Sport)'   }, color: '#22c55e' },
    { max: 1.00, label: { de: 'Sehr stark',           en: 'Very strong'       }, color: '#0088cc' },
    { max: 1.50, label: { de: 'Extrem (Race)',        en: 'Extreme (Race)'    }, color: '#a78bfa' },
    { max: Infinity, label: { de: 'Übertuned',        en: 'Overtuned'         }, color: '#f43f5e' },
  ],
  fDriveInertia: [
